...
@section("pageContent")
    <div class="flex flex-col md:flex-row">
        ...
        <main class="flex-1 p-6">
            <h2 class="font-bold">Фотографии клиента {{ $client->first_name }} {{ $client->last_name }}</h2>
            ...
            <section class="mt-4">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 text-center">
                        @foreach ($photos as $photo)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a class="mt-1 bg-red-700 p-1.5 text-white rounded" href="/client/deletePhoto/{{ $photo["id"] }}"
                ...
                <form method="POST" action="/client/addPhoto/{{ $client->id }}" enctype="multipart/form-data">
                    @csrf
                    <div>
